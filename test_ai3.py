...
print('Step 5e: expectimax depth=1', flush=True)
ai_engine.expectimax(dummy, 1, True, 6, 8)
print('Step 5f: expectimax depth=2', flush=True)
ai_engine.expectimax(dummy, 2, True, 6, 8)
print('Step 5g: expectimax depth=3', flush=True)
ai_engine.expectimax(dummy, 3, True, 6, 8)
